...
<!--      </el-date-picker>-->
<!--&lt;!&ndash;      <div class="trader-history-btn" style= >查询</div>&ndash;&gt;-->
<!--      <el-button :loading="traderHistoryBtnLoading" @click="getTraderHistory" type="primary" size="small" class="trader-history-btn">{{searchText}}</el-button>-->
...
<!--        if (val.indexOf('td')!=-1){-->
<!--          setTimeout(function () {-->
<!--            $('.trader-history-container').scrollTop(100);-->
<!--            console.log('设置高度')-->
<!--          },50)-->
<!--        }-->
<!--      }-->
...
<!--        }-->
<!--        this.loading=true-->
<!--        let from=this.dayFromTo[0];-->
<!--        let to = this.dayFromTo[1];-->
<!--        this.$emit('getTraderHistory',from+';'+to)-->
