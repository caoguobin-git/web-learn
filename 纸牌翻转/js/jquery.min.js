        ...
        init: function(e, t, n) {
            ...
            if ("string" == typeof e) {
                if (r = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e,
                        null
                    ] : T.exec(e), !r || !r[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(
                    t).find(e);
                if (r[1]) {
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(T).complete = d.add, T.success = T.done, T.error = T.fail, c.url = ((e || c.url ||
                ...
                c.method || c.type, c.dataTypes = x.trim(c.dataType || "*").toLowerCase().match(w) || [
                    ""
                ], null == c.crossDomain && (a = en.exec(c.url.toLowerCase()), c.crossDomain = !(!a ||
                    a[1] === _t[1] && a[2] === _t[2] && (a[3] || ("http:" === a[1] ? "80" : "443")) ===
                    (_t[3] || ("http:" === _t[1] ? "80" : "443")))), c.data && c.processData &&
            ...
            function k(e, t, o, a) {
                ...
                2 !== v && (v = 2, s && clearTimeout(s), n = undefined, i = a || "", T.readyState = e >
                    ...
                    (t || C) + "", l ? h.resolveWith(f, [m, C, T]) : h.rejectWith(f, [T, C, y]), T.statusCode(
                        ...
                        m : y
                    ]), d.fireWith(f, [T, C]), u && (p.trigger("ajaxComplete", [T, c]), --x.active ||
